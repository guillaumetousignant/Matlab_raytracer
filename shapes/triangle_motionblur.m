classdef triangle_motionblur < triangle
...
methods
    function obj = triangle_motionblur(material, points, normals, texcoord, transformation)
        obj = obj@triangle(material, points, normals, texcoord, transformation);
    ...
    function [normalvec, tuv] = normaluv(obj, uv, aray) %%% CHECK how do we get time...
