...
%% Scene
scene_name = 'portal room';
scene_struct.scene.Attributes.name = scene_name;
scene_struct.scene.Attributes.primitive_list = 'portal';
...
material_cell{end+1}.Attributes.name = 'difwhite';
...
transformation_pre_cell{end}.Attributes.value = [0, 0, 10];
material_cell{end}.transformations_pre.transformation_pre = transformation_pre_cell;

material_cell{end+1}.Attributes.name = 'portalmat';
material_cell{end}.Attributes.type = 'fresnelmix';
material_cell{end}.Attributes.material_refracted = 'portalmat1'; % can also be array
...
object_cell{end+1}.Attributes.name = 'portal';
object_cell{end}.Attributes.type = 'sphere';
object_cell{end}.Attributes.material = 'portalmat'; % can also be name
...
object_cell{end}.Attributes.material = 'difwhite'; % can also be name
object_cell{end}.Attributes.transform_matrix = NaN; % if not empty, search for right matrix, if empty, create.
transformation_pre_cell = cell(0);
transformation_pre_cell{end+1}.Attributes.type = 'translate';
transformation_pre_cell{end}.Attributes.value = [0, -1, 0];
transformation_pre_cell{end+1}.Attributes.type = 'uniformscale';
transformation_pre_cell{end}.Attributes.value = 2.5;
...
camera_cell{end}.Attributes.aperture = 0.00;
