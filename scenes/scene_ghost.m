...
scene_struct.scene.Attributes.primitive_list = 'planegrey1, planegrey2, airsphere';
...
scatterer_cell{end+1}.Attributes.name = 'air2_scatterer';
...
object_cell{end+1}.Attributes.name = 'airsphere';
