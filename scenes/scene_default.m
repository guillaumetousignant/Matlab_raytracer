...
scene_struct.scene.Attributes.primitive_list = 'spherepurple, mirror, light, sphereglass, ground';
...
material_cell{5}.Attributes.name = 'ref1';
material_cell{5}.Attributes.type = 'reflective';
material_cell{5}.Attributes.emission = 'black'; % can also be array
material_cell{5}.Attributes.colour = 'yellow'; % can also be array

material_cell{6}.Attributes.name = 'glass';
material_cell{6}.Attributes.type = 'reflective_refractive';
...
object_cell{2}.Attributes.name = 'mirror';
object_cell{2}.Attributes.type = 'sphere';
object_cell{2}.Attributes.material = 'ref1'; % can also be name
...
object_cell{4}.Attributes.name = 'sphereglass';
