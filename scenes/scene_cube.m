...
texture_cell{1}.Attributes.name = 'earth_texture';
texture_cell{1}.Attributes.type = 'texture';
texture_cell{1}.Attributes.filename = '.\assets\earth_2048.png';
...
material_cell{3}.Attributes.name = 'earth_mat';
material_cell{3}.Attributes.type = 'diffuse_tex';
material_cell{3}.Attributes.emission = 'black'; % can also be array
material_cell{3}.Attributes.texture = 'earth_texture'; % can also be index
...
object_cell{3}.Attributes.name = 'cube';
object_cell{3}.Attributes.type = 'mesh_motionblur';
object_cell{3}.Attributes.mesh_geometry = 'cube_mesh';
object_cell{3}.Attributes.material = 'earth_mat'; % can also be name
...
directional_light_cell{1}.Attributes.type = 'directional_light';s
transformation_pre_cell = cell(3, 1);
...
camera_cell{1}.Attributes.type = 'cam_motionblur';
...
camera_cell{1}.Attributes.time = [0, 1];
