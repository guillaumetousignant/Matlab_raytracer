...
scene_struct.scene.Attributes.primitive_list = 'portal1, portal2, planegrey1, planegrey2';
...
material_cell{end+1}.Attributes.name = 'difteal';
material_cell{end}.Attributes.type = 'diffuse';
material_cell{end}.Attributes.emission = 'teal'; % can also be array
material_cell{end}.Attributes.colour = 'white'; % can also be array
material_cell{end}.Attributes.roughness = 0.1;

material_cell{end+1}.Attributes.name = 'diforange';
material_cell{end}.Attributes.type = 'diffuse';
material_cell{end}.Attributes.emission = 'orange'; % can also be array
material_cell{end}.Attributes.colour = 'white'; % can also be array
material_cell{end}.Attributes.roughness = 0.1;

material_cell{end+1}.Attributes.name = 'portalmat11';
material_cell{end}.Attributes.type = 'portal';
material_cell{end}.Attributes.medium_list = 'air, air';
material_cell{end}.Attributes.transform_matrix = NaN;
...
material_cell{end}.transformations_pre.transformation_pre = transformation_pre_cell;

material_cell{end+1}.Attributes.name = 'portalmat12';
material_cell{end}.Attributes.type = 'portal';
material_cell{end}.Attributes.medium_list = 'air, air';
material_cell{end}.Attributes.transform_matrix = NaN;
transformation_pre_cell = cell(0);
...
material_cell{end+1}.Attributes.name = 'portalmat1';
material_cell{end}.Attributes.type = 'fresnelmix';
material_cell{end}.Attributes.material_refracted = 'portalmat11'; % can also be array
material_cell{end}.Attributes.material_reflected = 'diforange'; % can also be array
material_cell{end}.Attributes.ind = 1.5;

material_cell{end+1}.Attributes.name = 'portalmat2';
material_cell{end}.Attributes.type = 'fresnelmix';
material_cell{end}.Attributes.material_refracted = 'portalmat12'; % can also be array
material_cell{end}.Attributes.material_reflected = 'difteal'; % can also be array
material_cell{end}.Attributes.ind = 1.5;
...
object_cell{end+1}.Attributes.name = 'portal1';
object_cell{end}.Attributes.type = 'sphere';
object_cell{end}.Attributes.material = 'portalmat1'; % can also be name
...
object_cell{end+1}.Attributes.name = 'portal2';
object_cell{end}.Attributes.type = 'sphere';
object_cell{end}.Attributes.material = 'portalmat2'; % can also be name
object_cell{end}.Attributes.transform_matrix = NaN; % if not empty, search for right matrix, if empty, create.
transformation_pre_cell = cell(0);
transformation_pre_cell{end+1}.Attributes.type = 'translate';
transformation_pre_cell{end}.Attributes.value = [0, -3, 0];
transformation_pre_cell{end+1}.Attributes.type = 'uniformscale';
transformation_pre_cell{end}.Attributes.value = 0.77;
object_cell{end}.transformations_pre.transformation_pre = transformation_pre_cell;
