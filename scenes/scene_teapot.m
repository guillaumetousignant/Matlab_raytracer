...
material_cell{end+1}.Attributes.name = 'red_metal';
...
material_cell{end+1}.Attributes.name = 'teapotmat';
material_cell{end}.Attributes.type = 'fresnelmix';
material_cell{end}.Attributes.material_refracted = 'red_metal'; % can also be array
...
object_cell{end}.Attributes.type = 'mesh_motionblur';
object_cell{end}.Attributes.mesh_geometry = 'teapot_mesh';
object_cell{end}.Attributes.material = 'teapotmat'; % can also be name
...
transformation_pre_cell{end}.Attributes.value = -7 * pi/8;
