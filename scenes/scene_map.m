...
scene_struct.scene.Attributes.primitive_list = 'ground, triangleearth1, triangleearth2';
...
object_cell{end+1}.Attributes.name = 'triangleearth1';
object_cell{end}.Attributes.type = 'triangle';
object_cell{end}.Attributes.material = 'earthmat'; % can also be name
object_cell{end}.Attributes.points = [-1, 4, 1; -1, 4, -1; 1, 4, -1];
object_cell{end}.Attributes.normals = [0, -1, 0; 0, -1, 0; 0, -1, 0];
object_cell{end}.Attributes.texture_coordinates = [0, 1; 0, 0; 1, 0];
object_cell{end}.Attributes.transform_matrix = NaN; % if not empty, search for right matrix, if empty, create.
transformation_pre_cell = cell(0);
...
object_cell{end+1}.Attributes.name = 'triangleearth2';
object_cell{end}.Attributes.type = 'triangle';
object_cell{end}.Attributes.material = 'earthmat'; % can also be name
object_cell{end}.Attributes.points = [-1, 4, 1; 1, 4, -1; 1, 4, 1];
object_cell{end}.Attributes.normals = [0, -1, 0; 0, -1, 0; 0, -1, 0];
object_cell{end}.Attributes.texture_coordinates = [0, 1; 1, 0; 1, 1];
object_cell{end}.Attributes.transform_matrix = NaN; % if not empty, search for right matrix, if empty, create.
transformation_pre_cell = cell(0);
transformation_pre_cell{end+1}.Attributes.type = 'rotatezaxis';
transformation_pre_cell{end}.Attributes.value = 0;
